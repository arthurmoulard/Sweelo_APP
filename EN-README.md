...
classDiagram
    ...
    User "1" --> "N" Activity : owns
    User "N" --> "N" User : friends via Friendship
    Activity "1" --> "1" FeedPost : publishes
    FeedPost "1" --> "N" Comment : contains
    FeedPost "1" --> "N" Report : receives
    Comment "1" --> "N" Report : receives
    SweeloFacade --> User
